...
Per poder treballar amb ESP, s'ha d'haver instal·lat l'extensió ESP-IDF, que s'ha d'instal·lar i llavors hi ha un procés de configuració.

Un cop instal·lat, anar a View/Command i executar "ESP-IDF: Configure ESP-IDF Extension"

Per projectes d'exemple, executar "ESP-IDF Show example projects". Aquest exemple és l'exemple "Blink" extret d'aquí.

Per poder treballar, però abans s'han de seguir uns passos:
